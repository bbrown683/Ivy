...
int Ivy::System::Win32Window::GetWidth()
{
    return width;
}

void Ivy::System::Win32Window::SetWidth(int value)
{

}

int Ivy::System::Win32Window::GetHeight()
{
    return height;
}

void Ivy::System::Win32Window::SetHeight(int value)
{

}

float Ivy::System::Win32Window::GetAspectRatio()
{
    return width / static_cast<float>(height);
}

bool Ivy::System::Win32Window::GetRenderViewportNeedsResize()
{
    return viewportNeedsResize;
}

void Ivy::System::Win32Window::SetRenderViewportNeedsResize(bool value)
{
    viewportNeedsResize = value;
}

int Ivy::System::Win32Window::GetX()
{
    return x;
}

void Ivy::System::Win32Window::SetX(int value)
{

}

int Ivy::System::Win32Window::GetY()
{
    return y;
}

void Ivy::System::Win32Window::SetY(int value)
{
...
Ivy::Math::Point<int> Ivy::System::Win32Window::GetPosition()
{
    return Math::Point<int>(x, y);
}

void Ivy::System::Win32Window::SetPosition(int x, int y)
{

}

void Ivy::System::Win32Window::SetIcon(std::string filename)
{

}

bool Ivy::System::Win32Window::PollWindowEvents()
{
    MSG msg;
...
PlatformDisplay Ivy::System::Win32Window::GetPlatformDisplay()
{
    return hDC;
}

PlatformWindow Ivy::System::Win32Window::GetPlatformWindow()
{
    return hWnd;
}
...
void Ivy::System::Win32Window::Show()
{
    ShowWindow(hWnd, SW_SHOW);
}

void Ivy::System::Win32Window::Hide()
{
    ShowWindow(hWnd, SW_HIDE);
}

void Ivy::System::Win32Window::Restore()
{
    ShowWindow(hWnd, SW_RESTORE);
}

void Ivy::System::Win32Window::Maximize()
{

}

bool Ivy::System::Win32Window::Minimized()
{
    return false;
}

void Ivy::System::Win32Window::Minimize()
{

}

bool Ivy::System::Win32Window::Maximized()
{
    return false;
}

bool Ivy::System::Win32Window::IsVisible()
{
    return false;
}

bool Ivy::System::Win32Window::IsOpen()
{
    return open;
}

bool Ivy::System::Win32Window::IsFullscreen()
{
    return fullscreen;
}

bool Ivy::System::Win32Window::IsActive()
{
    return false;
}

Ivy::System::Timer Ivy::System::Win32Window::GetTimer()
{
    return timer;
}

Ivy::Input::Input Ivy::System::Win32Window::GetInput()
{
    return input;
}

Ivy::Input::Key Ivy::System::Win32Window::ConvertVirtualKey(WPARAM key)
{
    switch (key)
    {
...
bool Ivy::System::Win32Window::RegisterWindowClass(HINSTANCE hInstance)
{
    WNDCLASSEX wcex;
...
void Ivy::System::Win32Window::UnregisterWindowClass()
{
...
LRESULT Ivy::System::Win32Window::WindowProcedure(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
